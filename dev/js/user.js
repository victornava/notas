...
var actionBarItems = [{
    ...
    "subItem": [{
        ...
        "name": "Use as default",
        "action": function(){
            setDefaultNota(notasList[activeNota]);
        }
    }, {
        "name": "Save All",
        "action": saveNotas
    ...
    "subItem": [{
        ...
        "name": "pink",
        "html": "<span class='miniNota' style='background-color: #FFC0CB'></span>",
        "arg": "#FFC0CB"
    }, {
        "name": "blue",
        "html": "<span class='miniNota' style='background-color: #ADD8E6'></span>",
        "arg": "#ADD8E6"
    }, ]
}];
            ...
            "success": function(resp){
                if (resp.created) {
                    ...
                    for (tempId in created) {
                        nota = notasList["nota_" + tempId]; //nota: this is confusing, reference by id instead of htmlid
