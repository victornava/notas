...
try {
    ...
    $dbInfo = file("../.dbinfo");
    $dbInfo = split(":", $dbInfo[0]); //host, dbname, user, pass
    $attributes = array (PDO::ATTR_PERSISTENT=>true, PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION);
    $dbCon = new PDO("mysql: host=$dbInfo[0]; dbname=$dbInfo[1]", $dbInfo[2], $dbInfo[3], $attributes);
}
catch(Exception $e) {
    echo $e->getMessage();
    exit ;
